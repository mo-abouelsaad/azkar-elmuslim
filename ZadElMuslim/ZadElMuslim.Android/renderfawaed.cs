...
[assembly: ExportRenderer(typeof(ZadElMuslim.FawaedZikr), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class renderfawaed : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public renderfawaed(Context context) : base(context)
        {
