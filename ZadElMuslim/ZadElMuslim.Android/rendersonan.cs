...
[assembly: ExportRenderer(typeof(ZadElMuslim.Sonan), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class rendersonan : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public rendersonan(Context context) : base(context)
        {
