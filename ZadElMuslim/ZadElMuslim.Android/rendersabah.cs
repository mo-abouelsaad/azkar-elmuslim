...
[assembly: ExportRenderer(typeof(ZadElMuslim.sabah), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class rendersabah : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public rendersabah(Context context) : base(context)
        {
