...
[assembly: ExportRenderer(typeof(ZadElMuslim.Location), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class renderloc : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public renderloc(Context context) : base(context)
        {
