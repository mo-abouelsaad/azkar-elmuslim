...
[assembly: ExportRenderer(typeof(ZadElMuslim.About), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class renderabout : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public renderabout(Context context) : base(context)
        {
