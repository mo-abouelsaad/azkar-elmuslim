...
[assembly: ExportRenderer(typeof(ZadElMuslim.Tazkir), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class rendertazkir : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public rendertazkir(Context context) : base(context)
        {
