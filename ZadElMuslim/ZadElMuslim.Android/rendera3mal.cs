...
[assembly: ExportRenderer(typeof(ZadElMuslim.A3malElmuslim), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class rendera3mal : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public rendera3mal(Context context) : base(context)
        {
