...
[assembly: ExportRenderer(typeof(ZadElMuslim.Setting), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class rendersetting : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public rendersetting(Context context) : base(context)
        {
