...
[assembly: ExportRenderer(typeof(ZadElMuslim.masaa), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class rendermasaa : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public rendermasaa(Context context) : base(context)
        {
