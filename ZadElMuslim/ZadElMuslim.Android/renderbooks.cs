...
[assembly: ExportRenderer(typeof(ZadElMuslim.Books), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class Renderbooks : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public Renderbooks(Context context) : base(context)
        {
