...
[assembly: ExportRenderer(typeof(ZadElMuslim.Zikr), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class RenderZikr : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public RenderZikr(Context context) : base(context)
        {
