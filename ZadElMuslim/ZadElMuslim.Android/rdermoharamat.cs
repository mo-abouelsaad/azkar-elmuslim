...
[assembly: ExportRenderer(typeof(ZadElMuslim.Moharamat), typeof(PageImpInterfaceRendererDroid))]
...
namespace ZadElMuslim.Droid
{
    ...
    public class Rendermoharamat : PageRenderer, ISlideOverKitPageRendererDroid
    {
        ...
        public Rendermoharamat(Context context) : base(context)
        {
